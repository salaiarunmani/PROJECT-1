...
batch_size = 8 # how many images train at a time
...
model.add(Conv2D(32,(3,3),padding='same',kernel_initializer='he_normal',input_shape=(img_rows,img_cols,1)))#1 for grey scale
...
model.add(Activation('softmax')) #suppose 2 output
...
model.compile(loss='categorical_crossentropy',
              ...
              metrics=['accuracy']) #compiler part
